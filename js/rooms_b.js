...
living: {
  ...
  objects: [
    ...
    { id: 'livingshelf', x: 64, y: 30, w: 12, label: 'Shelf',
      svg: '<svg viewBox="0 0 120 100"><rect x="8" y="70" width="104" height="10" rx="4" fill="#8A5A3B"/><rect x="20" y="30" width="24" height="40" rx="5" fill="#FF9D6B"/><circle cx="72" cy="48" r="18" fill="#C49BE8"/><circle cx="72" cy="48" r="8" fill="#8A5FA8"/></svg>',
      onTap: async function (G) {
        G.sfx('pop');
...
playroom: {
  ...
  objects: [
    ...
    { id: 'box', x: 70, y: 78, w: 13, label: 'Cardboard box', glowSoft: true,
      svg: '<svg viewBox="0 0 130 110"><path d="M14 44 L116 44 L106 100 L24 100 Z" fill="#C49A6C"/><path d="M14 44 L40 20 L92 20 L116 44" fill="#D9B183"/><line x1="65" y1="20" x2="65" y2="44" stroke="#A87F52" stroke-width="4"/><rect x="46" y="60" width="38" height="20" rx="4" fill="#FFF6E8" opacity="0.7"/></svg>',
      onTap: async function (G) {
    ...
    { id: 'hatshelf', x: 16, y: 30, w: 11, label: 'Hat shelf',
      svg: '<svg viewBox="0 0 110 100"><rect x="8" y="70" width="94" height="10" rx="4" fill="#8A5A3B"/><ellipse cx="55" cy="58" rx="30" ry="9" fill="#8A5A3B"/><path d="M32 56 L38 20 L72 20 L78 56 Z" fill="#5A3A22"/><rect x="32" y="48" width="46" height="9" fill="#FFD65A"/></svg>',
      onTap: async function (G) {
        G.sfx('pop');
        await Nicko.react('wow');
        if (Inventory.unlock('hat')) G.toast('Silly hat found! Tap it in the toybox to wear it.', '🎩');
          ...
          G.spawn({ id: 'hat', x: 16, y: 52, w: 9, label: 'Silly hat', drag: true,
            svg: '<svg viewBox="0 0 100 80"><ellipse cx="50" cy="62" rx="34" ry="10" fill="#8A5A3B"/><path d="M22 60 L30 16 L70 16 L78 60 Z" fill="#5A3A22"/><rect x="22" y="52" width="56" height="10" fill="#FFD65A"/><circle cx="50" cy="14" r="8" fill="#FF9D6B"/></svg>',
